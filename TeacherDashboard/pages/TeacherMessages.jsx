  ...
  return (
    <div className="t-page">
      <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 18, flexWrap: 'wrap' }}>
        ...
        <div style={{ flex: 1, maxWidth: 480, display: 'flex', alignItems: 'center', gap: 10, background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 999, padding: '8px 16px' }}>
          <Icons.Search size={14} />
          <input placeholder="Search conversations..." style={{ flex: 1, border: 'none', outline: 'none', background: 'none', fontSize: 13 }} />
        </div>
        <Icons.Bell size={18} style={{ color: 'var(--ink-mute)' }} />
        <Icons.Settings size={18} style={{ color: 'var(--ink-mute)' }} />
