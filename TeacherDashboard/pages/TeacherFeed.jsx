...
export default function TeacherFeed() {
  ...
  return (
    <div className="t-page">
      <div style={{ display: 'flex', alignItems: 'center', gap: 32, marginBottom: 18, borderBottom: '1px solid var(--line)', paddingBottom: 12, flexWrap: 'wrap' }}>
        <div className="brand">
          <img src={logoImg} alt="PlanetX" className="brand-mark" style={{ height: 28 }} />
          <span>PlanetX</span>
        </div>
        <nav style={{ display: 'flex', gap: 24, fontSize: 14, fontWeight: 600, color: 'var(--ink-mute)' }}>
          <span style={{ color: 'var(--primary)', borderBottom: '2px solid var(--primary)', paddingBottom: 8 }}>Campus</span>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 10, background: 'var(--surface)', border: '1px solid var(--line)', borderRadius: 999, padding: '8px 16px', minWidth: 240 }}>
          ...
          <input placeholder="Search Campus..." style={{ flex: 1, border: 'none', outline: 'none', background: 'none', fontSize: 12 }} />
        </div>
        <Icons.Bell size={18} style={{ color: 'var(--ink-mute)' }} />
        <Icons.Zap size={18} style={{ color: 'var(--ink-mute)' }} />
