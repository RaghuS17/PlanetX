...
export default function MgmtClassEcosystem() {
  ...
  return (
    <div className="m-page">
      <div className="stagger" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24, flexWrap: 'wrap', gap: 12 }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, fontSize: 11, fontWeight: 700, color: 'var(--ink-mute)', letterSpacing: '0.08em' }}>
        ...
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '6px 14px', background: 'var(--primary-soft)', color: 'var(--primary)', borderRadius: 999, fontSize: 12, fontWeight: 700 }}>
          ⏱ 24 Active Ecosystems
        </div>
      </div>
