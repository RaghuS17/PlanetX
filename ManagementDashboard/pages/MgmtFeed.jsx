...
export default function MgmtFeed() {
  return (
    <div className="m-page">
      {/* Top breadcrumb */}
      <div className="stagger" style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 18, paddingBottom: 16, borderBottom: '1px solid var(--line)' }}>
        <div style={{ width: 36, height: 36, borderRadius: 8, background: 'var(--bg-soft)', display: 'grid', placeItems: 'center' }}>
          <Icons.Menu size={18} />
        </div>
        <div className="brand">
        ...
        <div style={{ marginLeft: 8, fontSize: 12, color: 'var(--ink-mute)' }}>· Institutional Portal</div>
        <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 12 }}>
          <Icons.Search size={18} style={{ color: 'var(--ink-mute)' }} />
          <Icons.Bell size={18} style={{ color: 'var(--ink-mute)' }} />
          <div className="avatar" style={{ background: 'linear-gradient(135deg, #5046e5, #1a1a2e)' }}>EV</div>
        </div>
      </div>
